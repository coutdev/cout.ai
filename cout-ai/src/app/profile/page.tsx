      ...
      <div className="min-h-screen flex items-center justify-center gradient-bg-subtle">
        <div className="flex flex-col items-center space-y-6 animate-fade-in-scale">
          ...
          <div className="text-center">
            <div className="text-xl font-semibold text-slate-700 dark:text-slate-200 mb-2">Loading Profile</div>
            <div className="text-sm text-muted">Preparing your account information...</div>
          </div>
